...
empty_entry_button.grid(row=3, column=0, padx=padx, pady=pady)
...
empty_entry_button.grid(row=3, column=1, padx=padx, pady=pady)
...
empty_entry_button.grid(row=3, column=2, padx=padx, pady=pady)
...
empty_entry_button.grid(row=3, column=3, padx=padx, pady=pady)


label_1 = tk.Label(frame_1, text="Weather")
label_1.grid(row=1, column=3, padx=padx, pady=pady)


entry_1 = tk.Entry(frame_1, width=24, justify="right")
entry_1.grid(row=2, column=3, padx=padx, pady=pady)
entry_1.insert(0, "")
